...
var top = $(document).scrollTop();
	if (top > 50) { $('#spine').not('.inserted').addClass('scanned'); }
...
$(document).mouseup(function (e) {
    ...
    /* var action_section = $("#wsu-actions section.opened");
    if (action_section.has(e.target).length === 0)
    { action_section.toggleClass('opened closed'); } */
});
